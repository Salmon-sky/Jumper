...
class Dino(pygame.sprite.Sprite):
    def __init__(self, x_pos, y_pos):
        ...
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("assets/Lari1c.png"), (100, 120)))
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("assets/Lari2c.png"), (100, 120)))
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("assets/Lari3c.png"), (100, 120)))
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("assets/Lari4c.png"), (100, 120)))

        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"assets/slidec.png"), (130, 110)))
        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"assets/slidec.png"), (130, 110)))
        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"assets/slidec.png"), (130, 110)))
    ...
    def __init__(self, x_pos, y_pos):
        ...
        for i in range(1, 7):
            current_sprite = pygame.transform.scale(
                pygame.image.load(f"assets/obstacle{i}.png"), (100, 100))
...
class Ptero(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.x_pos = 1300
        self.y_pos = random.choice([250, 355])
        self.sprites = []
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("assets/burung1.png"), (90, 72)))
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("assets/burung2.png"), (90, 72)))
        self.current_image = 0
